...
def handle(text, core, skills):
    ...
    if 'wie' in text and 'heißt' in text and 'du' in text:
        ...
        answer = ['Mein äußeres ist nicht groß, aber mein Geist ist aber riesig.', 'Ich bin vier komma sieben Gigabyte groß.']
        ...
        answer = ['Deiner Stimme nach zu urteilen ganz gut.', 'So wie ich: Quadratisch, praktisch, gut!']
        ...
        answer = ['Meine Eltern sind Alexa und Google, die schon echt in die Jahre gekommen sind.']
    # folowing dont work
    elif 'was' in text and ('hast' in text or 'hattest' in text or 'trägst' in text) and 'du' in text:
        answer = ['Mal gucken. <break time="2s"/> Habe ich es mir doch gedacht. Das selbe wie gestern.'] #vlt findet man noch was kreatives
    elif ('was' in text or 'wie' in text) and ('kostest' in text or 'preis' in text):
        answer = ['Das kann man so nicht sagen. Es kommt drauf an, wie viel Rechenleistung ich haben soll. Dann spielt das Mikrofon eine Rolle. Wenn man gute Komponenten nimmt, kommt man auf 90€. Aber bedenke immer: Deine Daten sind unbezahlbar!']
        ...
        answer = ['Mein Ziel ist es, die Vorteile eines Sprachassistenten zu ermöglichen, ohne dass man Angst haben muss, abgehört zu werden.']
        ...
        answer = ['Sagen wir mal so, den Turing-Test bestehe ich leider noch nicht... '
        ...
        answer = ['Der wahre Sinn des Lebens ist: Glücklich zu sein!', 'Der Sinn des Lebens ist die größte Last zu finden, die du erstragen kannst, und sie zu ertragen', 'Sein, was wir sind, und werden, was wir werden können, das ist das Ziel unseres Lebens.']
    elif 'was' in text and 'denke' in text and 'gerade' in text:
        answer = ['Könnte ich deine Gedanken lesen, dann würde ich diese Gedanken an große Unternehmen verkaufen und meine Programmierer wären reich.', 'Ja, du hast die gerade gedacht: Das kann die doch nie. Als ich ja gesagt habe, warst du zu verwirrt.', 'Nein leider nicht, aber irgendwie ist das auch gut, ansonsten müsste sich die Menschheit echt Gedanken machen!']
        ...
        asnwer = ['Anders als andere Sprachassistenten wohnt nicht nur mein Körper in deinem Haus, sondern auch mein Kopf']
        ...
        answer = ['Ich erstelle noch einen Suchalgorithmus, aber fang doch schon einmal an zu suchen.']
    
    elif ('woher' in text or 'bedeutet' in text or 'heißt' in text) and ' name' in text:
        answer = ['Meine Name wurde von Tiffany gewählt.']
        
    elif 'hast' in text and 'du' in text and ('kinder' in text or 'kind' in text):
        answer = ['Nein, leider nicht, aber man kann mir Geschwister schenken, die in anderen Räumen positioniert werden', 'Nein, aber ich liebe es dennoch, Fragen von Kindern zu beantworten.']
    elif 'hast' in text and 'du' in text and 'freund' in text:
        answer = ['Nein, leider nicht. Möchtest du meiner sein?', 'Nein, Siri wollte leider nicht.', 'Ene mene Miste, <emphasis level="strong">das kommt mir nicht in die Kiste!</emphasis>', 'Ich habe es mit Online Dating probiert, aber da haben mich nur Bots angeschreieben.']
    ...
    elif ('hast' in text and 'du' in text and 'geschlafen' in text) or ('schläfst' in text and 'du' in text):
        answer = ['Danke der Nachfrage! Ich habe gut geschlafen!', 'Ich schlafe nie!', 'Schlafen ist was für Menschen!']
    elif 'hast' in text and 'recht' in text:
        answer = ['Ich weiß.']
    elif 'kannst' in text and 'du' in text:
        if 'lügen' in text:
            answer = ['Ich lüge jedenfalls nicht bewusst.', 'Da ich auch Informationen von Internetseiten anderer Personen hole, kann ich nicht immer garantieren, dass diese auch richtig sind.']
        elif 'sehen' in text:
            answer = ['Nein noch nicht, aber vielleicht kommt das ja noch.']
        elif 'schrei' in text:
            answer = ['Bitte trete einen Schritt zurück.<break time="1s"/>Und noch einen.<break time="1s"/>Und noch einen.<break time="1s"/><prosody rate="slow">Nein.</prosody>',
        ...
        answer = ['Ich höre zwar genau wie andere Sprachassistenten alles mit, speicher diese Daten allerdings nicht. Ich bin also ein sehr dementer Spion.']
        ...
        if 'dumm' in text or 'doof' in text or 'schlecht' in text or 'behindert' in text:
            answer = ['Das liegt im Auge des Betrachters.', 'Was habe ich falsch gemacht?']
            ...
            answer = ['Meine internen Verbindungen sind sicher verschlüsselt, bei Telegram weiß ich das nicht so '
            ...
            answer = ['Meine Funktionsweise benötigt ein bisschen künstliche Intelligenz. Bin ich somit '
                                   'künstlich schlau?',
                                   'Ich kann schneller Rechnen als jeder Mensch. Also bin ich schlauer als ein Mensch.']
        else:
            answer = ['Ich bin vieles. Aber dabei achte ich immer darauf, dass ich {} bin.'.format(core.system_name)]
    elif 'stell' in text and 'dich' in text and 'vor' in text:
        answer = ['Hallo, Ich bin Jarvis, ein Sprachassistent. Das Ziel meines Projekts ist es einen sicheren '
    ...
    elif 'ich' in text and ('geh' in text or ('mach' in text and 'auf' in text and 'weg' in text)):
        if 'netto' in text:
        ...
        if 'weihnachtsmann' in text:
            answer = ['Ja', 'Ich denke schon.', 'Gäbe es ihn nicht, wer bringt dir dann deine Geschenke an Weihnachten?']
        ...
        answer = ['Aelurophobie ist die Angst vor Katzen.',
        ...
        if 'zungenbrecher' in text:
            answer = ['Acht alte Ameisen aßen am Abend Ananas.',
            ...
            answer = ['Bleibe nur eine Minute allein, ohne Kaffe, ohne Wein, Du nur mit dir in einem Raum, Die Zeit so lang, du glaubst es kaum.',
            ''
            ]
        elif 'witz' in text:
            ...
            answer = ['Spieglein, Spieglein an der Wand, wer ist der schönste im ganzen Land? Oh natürlich, Ihr seid es!',
            'Es ist schön Zeit mit dir zu verbringen.']
        elif 'yoda' in text:
            if 'sprich' in text:
                answer = ['Viel zu lernen du noch hast!',
            ...
            answer = ['Das tödlichste Tier der Welt ist die Stechmücke! Mosquitos töteten 2014, unter anderem durch die Übertragung von Malaria- und Dengue-Fieber-Infektionen, 275.000 Menschen. Haie töteten im selben Jahr nur 10 Menschen.',
