...
def isValid(text):
    ...
    if ('phobie' in text or 'ängste' in text or 'angst' in text) and (
        ...
        if 'stroh' in text and 'liegt' in text and 'hier' in text:
            ...
            return True
        elif ('ich' in text or 'wir' in text) and ('bin' in text or 'wir' in text) and (
                'kacke' in text or 'schlecht' in text or 'scheiße' in text or 'mies' in text):
            return True
        ...
        return True
            ...
            'zungenbrecher' in text or 'gedicht' in text or 'nettes' in text or 'yoda' in text):
        return True
    elif ('erzähl' in text or 'erzähle' in text or 'sag' in text) and (
            'zungenbrecher' in text or 'gedicht' in text or 'nettes' in text or 'yoda' in text or 'witz' in text or 'fun fact' in text or 'phobie' in text or 'krankheit' in text):
        return True
    elif 'aha' in text:
        return True
...
def handle(text, core, skills):
    ...
    # folowing dont work
        ...
        answer = [
            'Mal gucken. <break time="2s"/> Habe ich es mir doch gedacht. Das selbe wie gestern.']  # vlt findet man noch was kreatives
    ...
    elif ('was' in text and 'kannst' in text and 'du' in text) or 'verstehst du' in text or (
            'was' in text and 'funktionen' in text) or ('was' in text and 'fragen' in text):
        ...
        answer = ['Der wahre Sinn des Lebens ist: Glücklich zu sein!',
        ...
        if 'lügen' in text:
            answer = ['Ich lüge jedenfalls nicht bewusst.',
        ...
        if 'dumm' in text or 'doof' in text or 'schlecht' in text or 'behindert' in text:
            ...
            answer = ['Vielen Dank.', 'Ich wurde ja auch sehr kompetent erschaffen',
                      'Es freut mich, dass ich hilfreich bin!', 'Du Schleimer!']
        elif 'romantisch' in text:
            answer = ['Danke, das kann ich nur zurückgeben']
        elif 'kitzlig' in text:
            answer = ['Tatsächlich hat das noch keiner ausprobiert.', 'Ich denke nicht',
        ...
        answer = ['Ich fühle mich geehrt.', 'Such dir ne Freundin oder einen Freund du Perversling!',
        ...
        if 'osterhase' in text or 'osterhasen' in text:
            answer = ['Gäbe es ihn nicht, wer würde dir dann dein Osternest verstecken?',
                      'Aber natürlich gibt es den Osterhasen.']
        if 'weihnachtsmann' in text:
            answer = ['Ja', 'Ich denke schon.',
