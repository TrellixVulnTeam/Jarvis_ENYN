        ...
        if index > 1:
            ...
            if re.search(r"scheibe|scheiben|klotz|klötze", word):
                try:
                    ...
                    success = False
    if success:
        ret = "Um die Türme von Hanoi mit {} Scheiben und {} Felder optimal zu lösen, gibt es {} Möglichkeiten.".format(
            n, k, upsilon(n, k))
    else:
...
def movetime(text):
    ...
    if not nosuccess:
        ...
        ret = "Wenn man pro Sekunde einen Zug macht, benötigt man für {} Scheiben und {} Felder {}.".format(n, k,
                                                                                                            time_string)
    else:
        ret = "Ich konnte leider keine Zugzahl ermitteln"
    ...
    if not nosuccess:
        ...
        for move in moveslist:
            ...
            if firstmove:
                ...
                ret += ' Bewege {} die oberste Scheibe von Feld {} nach Feld {}.'.format(
                    konjunctionlist[random.randint(0, len(konjunctionlist) - 1)], startpeg, endpeg)
    else:
        ret = "Ich konnte leider keine Zugzahl ermitteln"
    return ret, not nosuccess
