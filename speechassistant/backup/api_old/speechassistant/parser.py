...
audio_file_parser.add_argument(
    "name", type=str, required=False, help="Name of a specific audio file"
)
audio_file_parser.add_argument(
    "old_name",
    type=str,
...
alarm_parser.add_argument(
    "time",
    type=dict[[str, int], [str, int], [str, int]],
    help="Activation-time of the alarm",
)
alarm_parser.add_argument(
    "sound", type=str, help="Name of the audio file which is played on alar"
)
...
alarm_parser.add_argument(
    "initiated", type=bool, help="Indicates if the sunrise function was started yet"
)
alarm_parser.add_argument(
    "last_executed", type=str, help="Date-string of last activation (DD.MM.YYYY)"
)
...
retakes_days_parser.add_argument(
    "date_of_day",
    type=list[days_one_day_parser],
...
retakes_activation_parser.add_argument(
    "clock_time",
    type=[activation_time_parser],
    help="Clock times, when this " "routine should start",
)
retakes_activation_parser.add_argument(
    "after_alarm",
    type=bool,
    help="Indicates, if the routine should start after " "an alarm at this day",
)
retakes_activation_parser.add_argument(
    "after_sunrise",
    type=bool,
    help="Indicates, if the routine should start after " "sunrise at this day",
)
retakes_activation_parser.add_argument(
    "after_sunset",
    type=bool,
    help="Indicates, if the routine should start after " "sunset at this day",
)
retakes_activation_parser.add_argument(
    "after_call",
    type=bool,
    help="Indicates, if the routine should start after an " "user call at this day",
)
...
action_command_parser.add_argument(
    "module_name", type=str, help="Name of module, which will be called"
)
action_command_parser.add_argument(
    "text", type=list[str], help="Text, with which the module will be called"
)

routine_action_parser = reqparse.RequestParser()
routine_action_parser.add_argument(
    "commands",
    type=list[action_command_parser],
    help="Modules, which are called by " "this routine",
)
...
routine_parser.add_argument(
    "on_commands",
    type=list[str],
    help="Commands (user says Jarvis, <command>), " "on which this routine starts.",
)
