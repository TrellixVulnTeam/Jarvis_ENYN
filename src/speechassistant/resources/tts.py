...
#             "/usr/lib/chromium-browser/chromedriver", chrome_options=self.get_opt()
#         )
...
#             while (
#                 self.state_of_button() == "creating"
#                 or self.state_of_button() == "waiting"
#             ):
#                 time.sleep(0.1)
...
#             in self.play_button.get_attribute("innerHTML")
#         ):
#             return "waiting"
#         elif (
...
#         opt.add_argument("window-size=720,480")
