...
def get_day() -> str:
    ...
    tage: dict[int, str] = {0: 'Montag', 1: 'Dienstag', 2: 'Mittwoch', 3: 'Donnerstag', 4: 'Freitag', 5: 'Samstag', 6: 'Sonntag'}

    output: str = 'Heute ist ' + str(tage.get(weekday)) + ' der ' + str(now.day) + '.' + str(now.month) + '.'
    return output
