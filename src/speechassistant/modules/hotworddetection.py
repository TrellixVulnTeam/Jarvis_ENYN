...
def handle(text, core, skills):
    ...
    if 'start' in text:
        ...
        core.say("Die Hotworddetection wurde eingeschaltet, ab jetzt höre ich wieder auf deine Komandos.",
                 output='speech')
        ...
        core.say("Die Hotworddetection wurde ausgeschaltet, ab jetzt höre ich nicht mehr auf deine Komandos.",
                 output='speech')
        core.say(
